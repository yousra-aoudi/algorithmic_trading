...
# The dates have been hardcoded, but you can modify them as you see fit! tick = web.DataReader(ticker, ’google’, start, end)

bench = web.DataReader(benchmark, ’google’, start, end)

# Calculate the percentage returns on each of the time series
tick[’daily_ret’] = tick[’Close’].pct_change() bench[’daily_ret’] = bench[’Close’].pct_change()
