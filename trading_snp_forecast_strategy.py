...
class SPYDailyForecastStrategy(Strategy): 
  ...
  def __init__(self, bars, events):
    ...
    self.model_start_date = datetime.datetime(2010,1,1) 
    self.model_end_date = datetime.datetime(2020,12,31) 
    self.model_start_test_date = datetime.datetime(2020,1,1)
    ...
    def create_symbol_forecast_model(self):
      # Create a lagged series of the S&P500 
      #US stock market index snpret = create_lagged_series(self.symbol_list[0], 
    ...
    def calculate_signals(self, event): 
      ...
      if self.bar_index > 5:
        ...
        pred_series = pd.Series({’Lag1’: lags[1]*100.0,
                                 ’Lag2’: lags[2]*100.0
                                }
                               )
...
if __name__ == "__main__":
  csv_dir = ’/path//csv/file’ #Path to file / symbol_list = [’SPY’]
