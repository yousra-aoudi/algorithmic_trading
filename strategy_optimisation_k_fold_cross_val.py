...
if __name__ == "__main__":
  ...
  snpret = create_lagged_series("^GSPC", datetime.datetime(2011,1,1),
                                datetime.datetime(2021,12,31), lags=5
                               )
  ...
  kf = cross_validation.KFold(len(snpret), n_folds=10, indices=False,
  ...
  print("Hit Rate/Confusion Matrix:") model = SVC(C=1000000.0, cache_size=200, 
